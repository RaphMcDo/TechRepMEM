...
```{r target-spat-fixed,echo=F,fig.ncol=1,out.width="100%",fig.align="center",dpi=200,fig.show="hold",fig.cap = "Station-specific estimated target species cathc rate for all data between 2000 and 2021 fit to random walk model."}
knitr::include_graphics("1phi_no_cons_mean_all_ldat.png")
```

```{r non-target-spat-fixed,echo=F,fig.ncol=1,out.width="100%",fig.align="center",dpi=200,fig.show="hold",fig.cap = "Station-specific estimated non-target species cathc rate for all data between 2000 and 2021 fit to random walk model."}
