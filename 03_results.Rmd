...
kableExtra::kable(valid_frame,booktab=T,escape=F,align="c",row.names = F, caption = "Outputs for model validation approaches, including root mean squared errors (RMSE), Akaike Information Criterion (AIC) and Bayesian Information Criterion (BIC).")
```
...
kableExtra::kable(par_estim_tab,booktab=T,escape=F,align="c",row.names = F, caption = "Estimated values of parameter for each different model fit with standard error in parentheses.")
