...
colnames(valid_frame)<-c("Observation RMSE","Target Field RMSE", "Non-Target Field RMSE", "AIC", "BIC")
...
colnames(par_estim_tab)<-c("Both Datasets (Full)","Fixed Stations (Full)", "Both Datasets (2017+)","Fixed Station (2017+)","Stratified Data (2017+)")
...
```{r vess-eff,echo=F,fig.ncol=2,out.width="60%",fig.align="center",dpi=200,fig.show="hold",fig.cap = "Distribution of estimated vessel effect for each dataset combinations fit to the random walk model."}
...
```{r rand-int,echo=F,fig.ncol=2,out.width="60%",fig.align="center",dpi=200,fig.show="hold",fig.cap = "Estimated random intercepts for different dataset combinations fit to random walk model."}
...
```{r target-indices,echo=F,fig.ncol=2,out.width="75%",fig.align="center",dpi=200,fig.show="hold",fig.cap = "Estimated overall index for target species for different dataset combinations fit to random walk model."}
...
```{r non-t-indices,echo=F,fig.ncol=2,out.width="75%",fig.align="center",dpi=200,fig.show="hold",fig.cap = "Estimated overall index for target species for different dataset combinations fit to random walk model."}
...
```{r target-spat,echo=F,fig.ncol=1,out.width="100%",fig.align="center",dpi=200,fig.show="hold",fig.cap = "Station-specific estimated target species cathc rate for all data between 2000 and 2021 fit to random walk model."}
knitr::include_graphics("all_ldat_both_data.png")
```

```{r non-target-spat,echo=F,fig.ncol=1,out.width="100%",fig.align="center",dpi=200,fig.show="hold",fig.cap = "Station-specific estimated non-target species cathc rate for all data between 2000 and 2021 fit to random walk model."}
...
```{r persist,echo=F,fig.ncol=2,out.width="60%",fig.align="center",dpi=200,fig.show="hold",fig.cap = "Persistence index between each years for observed target species (top panel) and non-target species (bottom panel) catch rates."}
