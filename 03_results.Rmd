...
```{r target-indices,echo=F,fig.ncol=2,out.width="75%",fig.align="center",dpi=200,fig.show="hold",fig.cap = "Estimated overall index for target species using data from the fixed stations and stratified survey design both together and separately between 2000 and 2021 and between 2017 and 2021"}
knitr::include_graphics(c("comp_all_ldat_2017_walk.png","comp_all_ldat_walk.png"))
```


```{r non-t-indices,echo=F,fig.ncol=2,out.width="75%",fig.align="center",dpi=200,fig.show="hold",fig.cap = "Estimated overall index for non-target species using data from the fixed stations and stratified survey design both together and separately between 2000 and 2021 and between 2017 and 2021."}
